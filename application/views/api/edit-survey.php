<form id="ajaxForm" class="list-block inputs-list"method="POST">
 <ul>
   <li>
     <div class="item-content">
       <div class="item-inner"> 
         <div class="item-title floating-label">Question</div>
         <div class="item-input">
           <input type="text" name="survey_question" id="survey_question" />
         </div>
       </div>
     </div>
   </li>
   <li>
     <div class="item-content">
       <div class="item-inner"> 
         <div class="item-title floating-label">Sort Order</div>
         <div class="item-input">
           <input type="text" name="survey_sort" id="survey_sort" />
         </div>
       </div>
     </div>
   </li>
...
$(function() {   
   ...
   $.ajax({
     url: baseUrl+'api/survey/detail/1',
     type: "GET"
   }).done(function(data)
   {
    console.log(data);
    $('#survey_question').val(data.survey_question);
    $('#survey_sort').val(data.survey_sort);
   });

   $('#signin').click(function()
   {
      $.ajax({
       url: baseUrl+'api/survey/edit/1',
       type: "POST",
